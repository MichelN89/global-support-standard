...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --port 8080 \
  --set-env-vars "GSS_PROVIDER_ENDPOINT=https://${SERVICE_NAME}-$(echo ${GCP_REGION} | tr - _)-$(gcloud config get-value project).a.run.app/v1,GSS_PROVIDER_HOST=0.0.0.0,GSS_PROVIDER_PORT=8080,GSS_COMPLIANCE_LEVEL=standard,GSS_CERTIFIED=false,GSS_TEST_SUITE_VERSION=0.2.3,GSS_ENABLE_LEGACY_LOGIN=0,GSS_ENABLE_AGENT_AUTH=0,GSS_RATE_LIMIT_ENABLED=1"
```
